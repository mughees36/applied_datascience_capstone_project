...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # dcc.RangeSlider for selecting payload range
                                dcc.RangeSlider(
                                    id='payload-slider',
                                    min=0,
                                    max=10000,
                                    ...
                                    value=[min_payload, max_payload]  # use variables defined from dataset
                                ),
...
# TASK 2: Add a callback function for site-dropdown → success-pie-chart
@app.callback(
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        # Group success vs failure counts
